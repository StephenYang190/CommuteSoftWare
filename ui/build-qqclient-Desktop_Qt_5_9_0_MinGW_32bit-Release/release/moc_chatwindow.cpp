...
QT_MOC_LITERAL(1, 11, 5), // "SendM"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 6), // "NewMss"
QT_MOC_LITERAL(4, 25, 3), // "str"
QT_MOC_LITERAL(5, 29, 24) // "on_msssend_returnPressed"

    },
    "chatwindow\0SendM\0\0NewMss\0str\0"
    "on_msssend_returnPressed"
};
...
void chatwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->SendM((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->NewMss((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->on_msssend_returnPressed(); break;
        default: ;
        }
        ...
        {
            typedef int (chatwindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&chatwindow::SendM)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject chatwindow::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_chatwindow.data,
...
// SIGNAL 0
int chatwindow::SendM(QString _t1)
{
    int _t0{};
